...
CUDA_VISIBLE_DEVICES=1 python3 -u /home/blu/jhu/codeswitch/v1.1/src/cslm/main.py \
    ...
    --decode_do_sample \
    --decode_output ${BLU_ARTIFACTS}/codeswitch/v1.1/mixture-of-softmax-exp160-$JOB_ID/checkpoint-${CHEKPOINT}/evaluations/${DECODE_MODE}/num-beams-${BEAM_SIZE}/predictions.${i}.json \
    --seed ${i}
done