...
do
  ...
  CUDA_VISIBLE_DEVICES=1 python3 -u /home/blu/jhu/codeswitch/v1.1/src/cslm/main.py \
      ...
      --encoder_config \
      /home/blu/jhu/codeswitch/v1.1/scripts/jsalt/configs/${NAME}/encoder-3-12-384-ctx=16.json \
      --decoder_config \
      /home/blu/jhu/codeswitch/v1.1/scripts/jsalt/configs/${NAME}/decoder-3-12-384-ctx=16.json \
      --train_file \
